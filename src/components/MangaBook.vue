        ...
        <div class="page-front">
          ...
          <template v-if="i - 1 === 0">
            <div style="display:flex;flex-direction:column;height:100%;position:relative;background:#fff;">
              ...
              <div class="jump-bar" style="position:relative;z-index:1;">
              ...
              <div style="background:#0a0a0a;border-top:4px solid #c8942a;padding:0.65rem 0.9rem 0.55rem;flex-shrink:0;position:relative;z-index:1;">
